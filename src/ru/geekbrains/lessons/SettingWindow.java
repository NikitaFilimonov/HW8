...
public class SettingWindow extends JFrame {
    ...
    public SettingWindow(GameWindow gameWindow) {
        ...
        jrbHumVsAi = new JRadioButton("HumVsAi", true); //true - это значит, что выбран по умолчанию
        jrbHumVsHum = new JRadioButton("HumVsHum");
        jrbHumVsHum.setEnabled(false);
        gameModeGroup = new ButtonGroup(); //объединяем в группу, чтобы можно было выбирать что-то одно
        ...
        slFieldSize = new JSlider(MIN_FIELD_SIZE, MAX_FIELD_SIZE, 3);
